--Configuration file for package "gfanInterface", automatically generated

-- This print statement may be commented out:
stderr << "--loading configuration for package \"gfanInterface\" from file " << currentFileName << endl
