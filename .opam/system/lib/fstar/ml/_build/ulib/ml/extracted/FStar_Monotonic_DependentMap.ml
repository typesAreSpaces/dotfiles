...
let empty : 'Aa 'Ab . unit -> ('Aa,'Ab) map = fun uu____123  -> [] 
let rec sel :
...
type ('Aa,'Ab,'Ainv,'Auu____462,'Auu____463) grows = unit
...
let alloc : 'Aa 'Ab 'Ainv . unit -> unit -> (unit,'Aa,'Ab,'Ainv) t =
  fun r  -> fun uu____2842  -> FStar_HyperStack_ST.ralloc () [] 
let extend :
  'Aa 'Ab 'Ainv . unit -> (unit,'Aa,'Ab,'Ainv) t -> 'Aa -> 'Ab -> unit =
  fun r  ->
    fun t  ->
      fun x  ->
        fun y  ->
          ...
          (let cur = FStar_HyperStack_ST.op_Bang t  in
           ...
           FStar_HyperStack_ST.mr_witness () () () (Obj.magic t) ())
    ...
    fun t  ->
      fun x  ->
        ...
        | FStar_Pervasives_Native.Some b ->
            (FStar_HyperStack_ST.mr_witness () () () (Obj.magic t) (); y)
