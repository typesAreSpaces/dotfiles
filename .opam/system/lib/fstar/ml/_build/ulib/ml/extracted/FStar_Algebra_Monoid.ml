...
let (conjunction_monoid : unit monoid) =
  intro_monoid () (fun a1  -> fun a2  -> ()) 
let (disjunction_monoid : unit monoid) =
  intro_monoid () (fun a3  -> fun a4  -> ()) 
...
let lift_monoid_option :
  ...
  fun m  ->
    let mult x y =
      ...
      | (uu____513,uu____514) -> FStar_Pervasives_Native.None  in
    intro_monoid
...
let (uu___156 : (unit,unit,unit neg,unit,unit) monoid_morphism) =
  intro_monoid_morphism (fun a5  -> ()) conjunction_monoid disjunction_monoid 
let (uu___165 : (unit,unit,unit neg,unit,unit) monoid_morphism) =
  intro_monoid_morphism (fun a6  -> ()) disjunction_monoid conjunction_monoid 
