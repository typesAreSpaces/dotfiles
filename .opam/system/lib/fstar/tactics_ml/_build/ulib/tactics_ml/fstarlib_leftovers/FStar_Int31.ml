...
let (add : t -> t -> t) =
  fun a  -> fun b  -> Mk (FStar_Int.add (Prims.of_int (31)) (v a) (v b)) 
let (sub : t -> t -> t) =
  fun a  -> fun b  -> Mk (FStar_Int.sub (Prims.of_int (31)) (v a) (v b)) 
let (mul : t -> t -> t) =
  fun a  -> fun b  -> Mk (FStar_Int.mul (Prims.of_int (31)) (v a) (v b)) 
let (div : t -> t -> t) =
  fun a  -> fun b  -> Mk (FStar_Int.div (Prims.of_int (31)) (v a) (v b)) 
let (rem : t -> t -> t) =
  fun a  -> fun b  -> Mk (FStar_Int.mod_ (Prims.of_int (31)) (v a) (v b)) 
let (logand : t -> t -> t) =
  fun x  -> fun y  -> Mk (FStar_Int.logand (Prims.of_int (31)) (v x) (v y)) 
let (logxor : t -> t -> t) =
  fun x  -> fun y  -> Mk (FStar_Int.logxor (Prims.of_int (31)) (v x) (v y)) 
let (logor : t -> t -> t) =
  fun x  -> fun y  -> Mk (FStar_Int.logor (Prims.of_int (31)) (v x) (v y)) 
let (lognot : t -> t) =
  fun x  -> Mk (FStar_Int.lognot (Prims.of_int (31)) (v x)) 
let (shift_right : t -> FStar_UInt32.t -> t) =
  fun a  ->
    fun s  ->
      Mk (FStar_Int.shift_right (Prims.of_int (31)) (v a) (FStar_UInt32.v s))
  
let (shift_left : t -> FStar_UInt32.t -> t) =
  fun a  ->
    fun s  ->
      Mk (FStar_Int.shift_left (Prims.of_int (31)) (v a) (FStar_UInt32.v s))
  
let (shift_arithmetic_right : t -> FStar_UInt32.t -> t) =
  fun a  ->
    fun s  ->
      Mk
        (FStar_Int.shift_arithmetic_right (Prims.of_int (31)) (v a)
           (FStar_UInt32.v s))
  
let (eq : t -> t -> Prims.bool) =
  fun a  -> fun b  -> FStar_Int.eq (Prims.of_int (31)) (v a) (v b) 
let (gt : t -> t -> Prims.bool) =
  fun a  -> fun b  -> FStar_Int.gt (Prims.of_int (31)) (v a) (v b) 
let (gte : t -> t -> Prims.bool) =
  fun a  -> fun b  -> FStar_Int.gte (Prims.of_int (31)) (v a) (v b) 
let (lt : t -> t -> Prims.bool) =
  fun a  -> fun b  -> FStar_Int.lt (Prims.of_int (31)) (v a) (v b) 
let (lte : t -> t -> Prims.bool) =
  fun a  -> fun b  -> FStar_Int.lte (Prims.of_int (31)) (v a) (v b) 
...
let (ct_abs : t -> t) =
  fun a  ->
    let mask =
      shift_arithmetic_right a (FStar_UInt32.uint_to_t (Prims.of_int (30)))
       in
    sub (logxor a mask) mask
  
let (to_string : t -> Prims.string) =
  fun uu____503  -> failwith "Not yet implemented:to_string" 
let (of_string : Prims.string -> t) =
  fun uu____515  -> failwith "Not yet implemented:of_string" 
