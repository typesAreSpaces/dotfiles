    ...
    fun n1  ->
      ...
      then FStar_Seq_Base.empty ()
        ...
        (let len1 = len - Prims.int_one  in
         let byte = FStar_UInt8.uint_to_t (n1 mod (Prims.of_int (256)))  in
         let n' = n1 / (Prims.of_int (256))  in
  ...
  fun l  ->
    fun b  ->
      ...
      then FStar_Seq_Base.empty ()
        ...
        (let uu____243 = FStar_Seq_Properties.split b (Prims.of_int (4))  in
         match uu____243 with
         | (hd1,tl1) ->
             FStar_Seq_Properties.cons (uint32_of_le hd1)
               (seq_uint32_of_le (l - Prims.int_one) tl1))
  ...
  fun l  ->
    fun b  ->
      ...
      then FStar_Seq_Base.empty ()
        ...
        (let uu____305 = FStar_Seq_Properties.split b (Prims.of_int (4))  in
         match uu____305 with
         | (hd1,tl1) ->
             FStar_Seq_Properties.cons (uint32_of_be hd1)
               (seq_uint32_of_be (l - Prims.int_one) tl1))
  ...
  fun l  ->
    fun b  ->
      ...
      then FStar_Seq_Base.empty ()
        ...
        (let uu____367 = FStar_Seq_Properties.split b (Prims.of_int (8))  in
         match uu____367 with
         | (hd1,tl1) ->
             FStar_Seq_Properties.cons (uint64_of_le hd1)
               (seq_uint64_of_le (l - Prims.int_one) tl1))
  ...
  fun l  ->
    fun b  ->
      ...
      then FStar_Seq_Base.empty ()
        ...
        (let uu____429 = FStar_Seq_Properties.split b (Prims.of_int (8))  in
         match uu____429 with
         | (hd1,tl1) ->
             FStar_Seq_Properties.cons (uint64_of_be hd1)
               (seq_uint64_of_be (l - Prims.int_one) tl1))
